    ...
    const services = [
        {
            ...
            description: "Custom web applications built with React, TypeScript, and modern frameworks, enhanced with AI capabilities for intelligent user experiences.",
        ...
        },
        {
            ...
            description: "Cross-platform mobile apps using React Native with AI-powered features, delivering native performance and smart functionality.",
            technologies: ["React Native", "Expo", "AI APIs", "Native APIs"],
            color: "from-purple-500 to-pink-500",
            features: ["Cross-Platform", "AI Features", "Native Performance"]
        },
        {
            icon: null,
            title: "Scalable Backend Solutions",
            description: "Robust server-side solutions with Node.js, Express.js, and AI service integrations for intelligent data processing.",
            technologies: ["Node.js", "Express.js", "REST APIs", "Microservices"],
            color: "from-green-500 to-emerald-500",
            features: ["Microservices", "API Design", "Cloud Ready"]
        }
    ];
    return (
                    ...
                    <div key={index} className="px-4">
                        ...
                        >
                            <div className="bg-white/5 backdrop-blur-2xl border border-white/20 p-8 hover:bg-white/8 transition-all duration-500 group relative overflow-hidden h-full rounded-3xl shadow-2xl shadow-black/20">
                                ...
                                <div className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-0 group-hover:opacity-3 transition-opacity duration-500 rounded-3xl`}></div>
                                ...
                                <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-50 transition-opacity duration-500">
                                    <div className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${service.color} p-px opacity-20`}>
                                ...
                                {/* Icon */}
                                <motion.div
                                    className={`w-20 h-20 rounded-3xl bg-gradient-to-br ${service.color} p-5 mb-8 relative z-10 shadow-lg`}
                                ...
                                <p className="text-gray-400 group-hover:text-gray-300 mb-6 leading-relaxed relative z-10 transition-colors duration-300">
                                    {service.description}
                                </p>
